...
Just save it as ``hello-world.py`` or something similar. Make sure to not call your
application ``baguette.py`` because this would conflict with Baguette itself.
